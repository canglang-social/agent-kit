...
3. Tie the specific code to one general, transferable idea the user can reuse
   elsewhere.
...
- If the user clearly wants deliberate practice rather than a quick answer,
  point them to /learn. If the explanation is worth remembering, suggest
  banking it with `/learn cards: <this concept>`.
